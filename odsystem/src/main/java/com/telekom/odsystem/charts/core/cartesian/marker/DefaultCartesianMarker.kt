...
import com.telekom.odsystem.charts.core.common.appendCompat
...
import com.telekom.odsystem.charts.core.common.shape.MarkerCorneredShape
...
public open class DefaultCartesianMarker(
    ...
    override fun drawOverLayers(
        ...
        with(context) {
//            This has been commented to draw guideline behind bar
//            drawGuideline(targets)
        ...
        with(context) {
            ...
            when (labelPosition) {
                ...
                LabelPosition.AbovePoint,
                    ...
                    tickPosition =
                        if (flip) {
                            MarkerCorneredShape.TickPosition.Top
                        } else {
                            MarkerCorneredShape.TickPosition.Bottom
                        }

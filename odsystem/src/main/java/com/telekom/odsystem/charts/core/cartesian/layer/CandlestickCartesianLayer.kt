...
import com.telekom.odsystem.charts.core.cartesian.data.CandlestickCartesianLayerModel.Change
...
import com.telekom.odsystem.charts.core.cartesian.marker.CandlestickCartesianLayerMarkerTarget
...
protected constructor(
    ...
    private fun CartesianDrawingContext.drawChartInternal(
        ...
        val halfMaxCandleWidth =
            candleProvider.getWidestCandle(model.extraStore).widthDp.half.pixels
    ...
    protected open fun CartesianDrawingContext.updateMarkerTargets(
        ...
        val limitedBodyBottomCanvasY =
            bodyBottomCanvasY.coerceIn(layerBounds.top, layerBounds.bottom)
        ...
        _markerTargets[entry.x] =
            listOf(
                CandlestickCartesianLayerMarkerTarget(
                    ...
                    entry = entry,
                    openingCanvasY =
                        if (entry.absoluteChange == Change.Bullish) {

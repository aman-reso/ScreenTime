    ...
    fun getMockChallenges(): List<Challenge> {
        return listOf(
            Challenge(
                ...
                rules = "<div><strong>Rules:</strong></div><ul><li>Track your screen time daily</li><li>Reduce usage by at least 30% from baseline</li><li>Submit stats regularly to maintain ranking</li><li>Only active app usage counts</li></ul>",
                tag = "Wellness",
                sponsor = "AppTime",

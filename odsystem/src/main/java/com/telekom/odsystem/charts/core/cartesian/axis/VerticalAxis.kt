...
import com.telekom.odsystem.charts.core.cartesian.axis.VerticalAxis.HorizontalLabelPosition.Inside
import com.telekom.odsystem.charts.core.cartesian.axis.VerticalAxis.HorizontalLabelPosition.Outside
import com.telekom.odsystem.charts.core.cartesian.axis.VerticalAxis.ItemPlacer.Companion.count
import com.telekom.odsystem.charts.core.cartesian.axis.VerticalAxis.ItemPlacer.Companion.step
...
import com.telekom.odsystem.charts.core.cartesian.data.formatForAxis
...
import com.telekom.odsystem.charts.core.cartesian.layer.CartesianLayerMargins
import com.telekom.odsystem.charts.core.cartesian.layer.HorizontalCartesianLayerMargins
...
import com.telekom.odsystem.charts.core.common.translate
                ...
                is Size.Auto -> {
                    ...
                    val labelSpace =
                        when (horizontalLabelPosition) {
                            Outside -> ceil(getMaxLabelWidth(freeHeight)).also {
                                maxLabelWidth = it
                            } + tickLength
        ...
        companion object {
            ...
            fun step(
                ...
                DefaultVerticalAxisItemPlacer(
                    DefaultVerticalAxisItemPlacer.Mode.Step(step),
                    shiftTopLines
                )

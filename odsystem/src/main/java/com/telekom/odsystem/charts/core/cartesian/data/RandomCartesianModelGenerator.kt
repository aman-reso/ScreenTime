...
import com.telekom.odsystem.charts.core.common.length
import com.telekom.odsystem.charts.core.common.random
        ...
        for (i in x) {
            ...
            val closingPrice =
                openingPrice +
                        Random.nextFloat() *
                        if (isBullish) {
                            (openingClosingRange.endInclusive - openingPrice).coerceAtMost(
                                maxClosingPriceDelta
                            )
                        } else {

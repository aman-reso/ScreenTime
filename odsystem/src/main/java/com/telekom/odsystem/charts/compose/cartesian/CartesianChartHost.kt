...
import com.telekom.odsystem.charts.compose.cartesian.data.component1
import com.telekom.odsystem.charts.compose.cartesian.data.component2
import com.telekom.odsystem.charts.compose.cartesian.data.component3
import com.telekom.odsystem.charts.compose.cartesian.data.component4
...
import com.telekom.odsystem.charts.core.common.Defaults.CHART_HEIGHT
...
import com.telekom.odsystem.charts.core.common.set
    ...
    LaunchedEffect(scrollState.pointerXDeltas) {
        scrollState.pointerXDeltas.collect { delta ->
            pointerPosition.value?.let { point ->
                pointerPosition.value = point.copy(point.x + delta)
            }
        }
    }

...
data class ODSChatTextIncomingTokens(
...
val defaultODSChatTextIncomingTokens = ODSChatTextIncomingTokens(
    padding = ODSPadding(
...
var DSChatTextIncomingTokens: ODSChatTextIncomingTokens = defaultODSChatTextIncomingTokens

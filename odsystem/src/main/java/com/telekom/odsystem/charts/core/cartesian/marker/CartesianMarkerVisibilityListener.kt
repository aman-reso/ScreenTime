...
@Immutable
interface CartesianMarkerVisibilityListener {
  /** Called when the specified [CartesianMarker] is shown. */
  fun onShown(marker: CartesianMarker, targets: List<CartesianMarker.Target>) {}

  /** Called when the specified [CartesianMarker]’s [CartesianMarker.Target]s change. */
  fun onUpdated(marker: CartesianMarker, targets: List<CartesianMarker.Target>) {}

  /** Called when the specified [CartesianMarker] is hidden. */
  fun onHidden(marker: CartesianMarker) {}
}
